require ('pg')
class Property
  attr_reader :id, :year_built, :address, :number_of_bedrooms
  attr_accessor :value
  ...
  def Property.find_by_address(address)
    ...
    houses = db.exec_prepared("find_by_address", values)
    db.close
    return houses.map { |house| Property.new(house) } if houses.any?
  end
